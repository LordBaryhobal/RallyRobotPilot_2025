...
class SensingSnapshot:
    ...
    def pack(self):
        ...
        byte_data += struct.pack(">fffff", self.car_position[0], self.car_position[1],
    ...
    def unpack(self, data):
        ...
        self.raycast_distances, data = iter_unpack(
            ">" + "f" * nbr_raycasts, data)
...
class SensingSnapshotManager:
    ...
    def add_message_chunk(self, chunk):
        ...
        if len(self.pending_data) < sizeheader:
            return
        ...
        if message_size+sizeheader <= len(self.pending_data):
            ...
            snapshot.unpack(
                self.pending_data[sizeheader:sizeheader+message_size])
